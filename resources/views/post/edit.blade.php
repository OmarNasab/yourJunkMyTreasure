<x-app-layout>
    <div class="m-12 mx-52 bg-white rounded-lg">
        <div class="flex justify-between py-4 mb-4 border-0 border-b-2 p-10">
            <h2 class="text-4xl font-extrabold dark:text-white">Edit {{$post->title}}</h2>
        ...
        <div class="relative overflow-x-auto sm:rounded-lg px-10 pb-10">
            <form method="post" action="{{route("post.update",$post)}}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Post Description">{{ $post->description }}</textarea>
                ...
                <div class="mb-4" x-data="{ file: null }">
                    ...
                    <div class="flex items-center justify-center w-full" >
                        <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            ...
                            <input id="dropzone-file" name="image" type="file" class="hidden" @change="file = $event.target.files[0]" />
                            <div x-show="file" class="text-center">
                                <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">File Selected</p>
                                <p x-show="file"  x-text="file.name" class="mb-2 text-sm text-gray-500 dark:text-gray-400"></p>
                            </div>
                        </label>
                    </div>
